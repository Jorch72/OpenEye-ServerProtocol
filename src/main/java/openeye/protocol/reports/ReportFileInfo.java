...
public class ReportFileInfo implements IReport {
	...
	public static class SerializableMod {
		...
		public Collection<Artifact> requiredMods = ImmutableList.of();

		@SerializedName("dependants")
		public Collection<Artifact> dependants = ImmutableList.of();

		@SerializedName("dependencies")
		public Collection<Artifact> dependencies = ImmutableList.of();
	}
